/* @ts-self-types="./mib_rust_wasm.d.ts" */
...
if (Symbol.dispose) RustE2eEpisode.prototype[Symbol.dispose] = RustE2eEpisode.prototype.free;

export class RustEpisode {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
...
if (Symbol.dispose) RustEpisode.prototype[Symbol.dispose] = RustEpisode.prototype.free;
...
const RustE2eEpisodeFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_ruste2eepisode_free(ptr, 1));
const RustEpisodeFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_rustepisode_free(ptr, 1));
